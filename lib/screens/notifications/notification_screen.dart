...
class NotificationScreen extends StatefulWidget {
  ...
  NotificationScreen({
    required this.notificationListss
  });
            ...
            children: [
              Container(
                ...
                child: ListView.builder(
                  ...
                  return widget.notificationListss[index].notificationType != "5" ? 
                  eventRequestCard(size, widget.notificationListss[index])
                  : eventAcceptCard(size, widget.notificationListss[index]);
                }),
              ),
            ],
          ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text(singleNotification.eventName,
                    style: GoogleFonts.montserrat().copyWith(
                      color: Colors.white,
                    ...
                    const Spacer(),
                    Text(getDate(singleNotification.createdAt),
                    style: GoogleFonts.montserrat().copyWith(
                      color: Colors.white,
                ...
                Text(singleNotification.adminMsg,
      ...
      onTap: (){
        ...
        AwesomeDialog(
          ...
          body: Column(
            ...
            children: [
              Center(
                child: Text("Your Entrance QR Code is",
                style: GoogleFonts.montserrat().copyWith(
                  color: Colors.white
                ),
                ),
              ...
              Container(
                padding: EdgeInsets.symmetric(horizontal: size.width*0.075,vertical: size.width*0.05),
                child: QrImage(
                  data: "1",
              ...
              Padding(
                ...
                child: Text("This QR Code is for entrance, present this at the door",
                style: GoogleFonts.montserrat().copyWith(
                  color: Colors.white
                ),
                ),
