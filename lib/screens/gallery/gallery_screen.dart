            ...
            flexibleSpace: Container(
              ...
              decoration:  BoxDecoration(
                ...
                image: DecorationImage(
                  colorFilter: ColorFilter.mode(const Color(0xFF74F9B8).withOpacity(0.5), BlendMode.dstATop) ,
                  image: const AssetImage("images/galback.png",
                  ),
                  fit: BoxFit.fill
                  ),
              ),
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GalleryEventCard(
                            imageUrl: galleryEventsList[index].imageURL + galleryEventsList[index].eventImage,
                            ...
                            djStatus: galleryEventsList[index].goingStatus.toString(),
                            djid: djID.toString(),
