        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            GestureDetector(
              onTap: () {
                Get.to(
                    NotificationScreen(notificationListss: notificationList));
              },
              child: Padding(
                padding: EdgeInsets.only(right: size.width * 0.05),
                child: const Icon(
                      ...
                      : GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return EventCard(
                                ...
                                qrCodeStatus: eventList[index].qrCodeStatus);
                          },
                        ),
                ),
              ),
