...
class EventService {
  Future<List<EventModel>> getEventsList(String djid) async {
    ...
    final response = await http.post(
      Uri.parse("http://kaspar.eastus.cloudapp.azure.com/jynx_club/api/dj_event_list_api"),
  ...
  Future<String> acceptEvent(String djid, String eventid) async {
    ...
    final response = await http.post(
      Uri.parse("http://kaspar.eastus.cloudapp.azure.com/jynx_club/api/accept_event"),
      body: jsonEncode(jsonMap)
    );
  ...
  Future<String> rejectEvent(String djid, String eventid) async {
    ...
    final response = await http.post(
      Uri.parse("http://kaspar.eastus.cloudapp.azure.com/jynx_club/api/reject_event"),
      body: jsonEncode(jsonMap)
    );
